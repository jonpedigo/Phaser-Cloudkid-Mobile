...
(function(cloudkid, undefined) {
	 ...
	 */
	var Particle = function(emitter, game)
	{
...
(function(cloudkid, undefined) {
	 ...
	 */
	var Emitter = function(particleParent, particleImages, config, game)
	{
		/**
			...
			while(this._spawnTimer <= 0)
			{
				...
				if(-this._spawnTimer < lifetime)
				{
					...
					for(var len = Math.min(this.particlesPerWave, this.maxParticles - this.particleCount); i < len; ++i)
					{
						...
						{
							p = new this.particleConstructor(this, this._game);
						}
